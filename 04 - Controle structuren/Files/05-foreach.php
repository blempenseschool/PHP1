...
<body>
  ...
  print "<ul>";
    ...
    // 1. Zorg ervoor dat deze <li>'s uit de array afgedrukt worden
    // ---------------------------------------------------------------- 
    print "<li>maandag</li>";
    print "<li>dinsdag</li>";
  ...
  print "<ul>";
    ...
    // 2. Zorg ervoor dat de maaltijden uit de array afgedrukt worden
    // ----------------------------------------------------------------
  ...
  print "<h2>Gebruikers</h2>";
    ...
    // 3. Zorg ervoor dat de gebruiker gegevens uit de array afgedrukt worden.
    // -------------------------------------------------------------------------
